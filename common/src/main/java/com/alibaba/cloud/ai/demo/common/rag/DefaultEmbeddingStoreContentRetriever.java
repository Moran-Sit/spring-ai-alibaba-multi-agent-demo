...
import com.alibaba.cloud.ai.demo.common.exception.BaseException;
...
import static com.alibaba.cloud.ai.demo.common.enums.ErrorEnum.B_BREAK_SEARCH;
 ...
 */
@Slf4j
public class DefaultEmbeddingStoreContentRetriever implements ContentRetriever {
    ...
    public DefaultEmbeddingStoreContentRetriever(EmbeddingStore<TextSegment> embeddingStore,
    ...
    private DefaultEmbeddingStoreContentRetriever(String displayName,
        ...
        this.embeddingModel = ensureNotNull(
                getOrDefault(embeddingModel, DefaultEmbeddingStoreContentRetriever::loadEmbeddingModel),
                "embeddingModel"
        );
    ...
    public static AdiEmbeddingStoreContentRetrieverBuilder builder() {
        return new AdiEmbeddingStoreContentRetrieverBuilder();
    }
    ...
    public static class AdiEmbeddingStoreContentRetrieverBuilder {
        ...
        public AdiEmbeddingStoreContentRetrieverBuilder displayName(String displayName) {
            this.displayName = displayName;
            return this;
        }

        public AdiEmbeddingStoreContentRetrieverBuilder embeddingStore(EmbeddingStore<TextSegment> embeddingStore) {
            this.embeddingStore = embeddingStore;
            return this;
        }

        public AdiEmbeddingStoreContentRetrieverBuilder embeddingModel(EmbeddingModel embeddingModel) {
            this.embeddingModel = embeddingModel;
            return this;
        }

        public AdiEmbeddingStoreContentRetrieverBuilder dynamicMaxResults(Function<Query, Integer> dynamicMaxResults) {
            this.dynamicMaxResults = dynamicMaxResults;
            return this;
        }

        public AdiEmbeddingStoreContentRetrieverBuilder dynamicMinScore(Function<Query, Double> dynamicMinScore) {
            this.dynamicMinScore = dynamicMinScore;
            return this;
        }

        public AdiEmbeddingStoreContentRetrieverBuilder dynamicFilter(Function<Query, Filter> dynamicFilter) {
        ...
        public DefaultEmbeddingStoreContentRetriever build() {
            return new DefaultEmbeddingStoreContentRetriever(this.displayName, this.embeddingStore, this.embeddingModel, this.dynamicMaxResults, this.dynamicMinScore, this.dynamicFilter, this.breakIfSearchMissed);
        }
     ...
     */
    public static DefaultEmbeddingStoreContentRetriever from(EmbeddingStore<TextSegment> embeddingStore) {
