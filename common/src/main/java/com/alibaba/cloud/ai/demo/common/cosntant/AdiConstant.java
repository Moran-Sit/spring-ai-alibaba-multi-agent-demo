package com.alibaba.cloud.ai.demo.common.cosntant;
...
public class AdiConstant {
    ...
    public static final String SILICONFLOW_DEFAULT_FREE_MODEL = "deepseek-ai/DeepSeek-R1-0528-Qwen3-8B";
     ...
     * 文本摘要模板
     */
    public static final String BRIEF_PROMPT_TEMPLATE = """
            请根据文本内容整理成一段连贯、通顺的摘要
    ...
    public static final Double LLM_LOW_TEMPERATURE_DEFAULT = 0.2D;
    ...
    public static final String KB_KEY = "kb_id";

    public static final String DOC_KEY = "doc_id";

    public static final Long DEFAULT_TOP_N = 10L;
    ...
    public static class McpConstant {
        ...
        public static final String TRANSPORT_TYPE_STREAMABLE = "streamable";
